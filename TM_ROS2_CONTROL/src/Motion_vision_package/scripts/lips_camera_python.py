...
#定義圖片保存路徑
save_dir = '/home/lips/TM_ROS2_CONTROL/src/Motion_vision_package/tag_detect_image'
...
while True:
    ...
    if input == ord('q'):
        ...
        cv2.imwrite(os.path.join(save_dir, 'rgb_image.png'), rgbMat)
        cv2.imwrite(os.path.join(save_dir, 'depth_image.png'), depthMat)
        print("Images saved: rgb_image.png, depth_image.png")
